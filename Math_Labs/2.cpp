...
void method_2()
{
    ...
    while (b <= a)  // Проверка корректности ввод данных
    {
    ...
    c = a - (b - a) / (f(b) - f(a)) * f(a);     // высчитывание точки пересечения. Куда мы в последствии проведем перпендекуляр к графику. Что в итоге стане тнашей точкой
